...
class LinearBottleneck(nn.Module):
    def __init__(self, inplanes, outplanes, stride=1, t=6, act_id=1, init_value=1.0):
...
class MobileNet2(nn.Module):
    ...
    def __init__(self, scale=1.0, input_size=224, t=6, in_channels=3,
                 num_classes=1000, act_id=1, init_value=1.0):
        """
    ...
    def _make_stage(self, inplanes, outplanes, n, stride, t, stage):
        ...
        first_module = LinearBottleneck(inplanes=inplanes, outplanes=outplanes, stride=stride, t=t,
                                        act_id=self.act_id, init_value=self.init)
